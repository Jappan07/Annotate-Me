(function () {
  ...
  var API_KEY = "flnafbI4QzK78LGhCRTbQg";
   ...
   */
  var API_SECRET = "ps9OSLcJK1EmPTTqC9HLDLLd0QljBKyKLLzp";
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      console.log("meeting number" + meetingConfig.mn)
      console.log("meeting password" + meetingConfig.pwd)
